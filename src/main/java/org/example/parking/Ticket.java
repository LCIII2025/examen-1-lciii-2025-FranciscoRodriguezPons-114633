...
public class Ticket {
    ...
    public double calcularPrecio() {
        // TODO implementar el metodo para calcular el importe a abonar segun el tipo de vehiculo LISTO
        ...
        switch (vehiculo.getTipo()) {
            ...
            case PICKUP:
                ...
                break;
            default:
                throw new IllegalArgumentException("Tipo de vehículo no determinado");
        }
