...
public class Estacionamiento {
    ...
    public boolean ingresarVehiculo(String dni, String nombre, Vehiculo vehiculo) {
        // TODO implementar la logica para registrar el ingreso de un nuevo vehiculo en el parking LISTO
        ...
        Vehiculo existente = cliente.buscarVehiculoPorPatente(vehiculo.getPatente());
        if (existente == null) {
    ...
    public Ticket retirarVehiculo(String patente) throws Exception {
        // TODO implementar la lógica para retirar un vehiculo del parking LISTO
